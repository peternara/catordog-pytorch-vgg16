...
def train():
    ...
    for i in range(epoch_num):
        ...
        torch.save(model, '../log/dog_cat_model_resnet50.pkl')

def test():
    model = torch.load('../log/dog_cat_model_resnet50.pkl')
    model = model.cuda()
    #model.eval()
...
def predict():
    ...
    test_dataloader2 = data.DataLoader(test_dataset2, batch_size=50, shuffle=False)
